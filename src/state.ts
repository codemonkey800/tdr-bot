...
The emoji dictionary is defined below with the following format: "{name}: {description}"
...
<:kingD:564330611515588618>: When someone random or funny happens
...
Emojis can be sent in the format: ":{name}:"
